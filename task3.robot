...
${error_payout_input}       //input[@class="dc-input-wrapper__input input--has-inline-prefix input input--error trade-container__input"]
...
Buy lower contract
    ...
    Wait Until Element Is Visible    ${payout_input}    15
    Press Keys    ${payout_input}    CTRL+a+BACKSPACE
    Input Text    ${error_payout_input}    15.50
